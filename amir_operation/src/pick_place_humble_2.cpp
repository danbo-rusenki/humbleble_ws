 ...
 */
 ...
 int main(int argc, char **argv) {
  ...
  // // RCLCPP_INFO(node->get_logger(), "Move above object");
  // // moveTo(arm, 0.0, 0.4, 0.3, 0.0, 90.0, 0.0, 0.6);
  // // controlGripper(gripper, 0.0);
  ...
  //  moveTo(arm, -OBJECT_POSITION[0], OBJECT_POSITION[1], OBJECT_DIMENSION[2] + 0.2,
  //         -90.0, 0.0, 90.0, 0.6);
  //  RCLCPP_INFO(node->get_logger(), "Place object slowly");
  //  moveTo(arm, -OBJECT_POSITION[0], OBJECT_POSITION[1], OBJECT_DIMENSION[2] ,
  //         -90.0, 0.0, 90.0, 0.3);
