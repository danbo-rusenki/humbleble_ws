...
/**
 * @brief A ros2_behavior_tree::BtActionNode class that wraps nav2_msgs::action::NavigateToPose
 */
class NavigateToPoseAction : public BtActionNode<nav2_msgs::action::NavigateToPose>
{
public:
  /**
   * @brief A constructor for ros2_behavior_tree::NavigateToPoseAction
  ...
  void on_tick() override
  {
    ...
    {
      std::cout << goal_.pose.header.frame_id << std::endl;
    }
  }
