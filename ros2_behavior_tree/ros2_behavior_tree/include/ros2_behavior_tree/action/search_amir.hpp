...
#ifndef ROS2_BEHAVIOR_TREE__ACTION__SEARCH_AMIR_HPP_
#define ROS2_BEHAVIOR_TREE__ACTION__SEARCH_AMIR_HPP_
...
using SearchAmir = behavior_tree_msgs::action::SearchAmir;

class SearchAmirNode : public ros2_behavior_tree::ROS2ActionClientNode<SearchAmir>
{
public:
  explicit SearchAmirNode(const std::string & name, const BT::NodeConfiguration & config)
  : ROS2ActionClientNode<SearchAmir>(name, config)
  {
  }
 ...
 BT::NodeStatus set_bt_result(
    typename rclcpp_action::ClientGoalHandle<SearchAmir>::WrappedResult & result) override
  {
    switch (result_.code) {
...
#endif  // ROS2_BEHAVIOR_TREE__ACTION__SEARCH_AMIR_HPP_
